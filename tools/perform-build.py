...
parser.add_argument('--platform', type=str, choices=['linux64-g++', 'darwin-mavericks', 'windows-mingw-w64', 'th-rhel7-gcc', 'th-rhel7-qt52', 'th-rhel7-qt53', 'th-rhel7-qt54'], default='linux64-g++')
